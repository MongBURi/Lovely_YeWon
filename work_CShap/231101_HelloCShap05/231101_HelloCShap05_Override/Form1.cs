...
namespace _231101_HelloCShap05_Override
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)  // 사자
        {
            Lion l = new Lion();
        ...
        private void button2_Click(object sender, EventArgs e)  // 호랑이
        {
            Tiger t = new Tiger();
            t.Name = "춘식이";
            t.Age = 7;
        ...
        {
            // 모달리스
            // 뒤에 창 제어 가능하고 코드는 계속 진행됨(동시에 쫙 뜲)
            MyForm m = new MyForm();
